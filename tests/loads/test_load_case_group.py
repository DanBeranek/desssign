...
def test_init(load_cases: list[DesignLoadCase]) -> None:
...
def test_number_of_load_cases(load_cases: list[DesignLoadCase]) -> None:
    load_case_group = DesignLoadCaseGroup(load_cases, LoadCaseRelation.STANDARD)
    assert load_case_group.number_of_load_cases == len(load_cases)


def test_standard_relation(load_cases: list[DesignLoadCase]) -> None:
    load_case_group = DesignLoadCaseGroup(load_cases, LoadCaseRelation.STANDARD)
...
def test_together_relation(load_cases: list[DesignLoadCase]) -> None:
...
def test_exclusive_relation(load_cases: list[DesignLoadCase]) -> None:
...
def test_invalid_relation(load_cases: list[DesignLoadCase]) -> None:
